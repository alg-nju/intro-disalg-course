...
%--
\include{./MainText/paxos} 

%--
\include{./MainText/raft} 

%--
\part{共享内存}

%--
\include{./MainText/ato-reg} 

%--
\part{理论专题}

%--
\include{./MainText/indis} 
...
%--
\include{./MainText/paxos-sys} 

%--
\include{./MainText/fault-tole} 

%--
\part{验证专题}

%--
\include{./MainText/mc-prot} 

%--
\include{./MainText/th-pr} 
